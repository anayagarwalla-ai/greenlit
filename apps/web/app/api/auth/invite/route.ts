...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (existingInvite?.status === "REMOVED") return NextResponse.json({ error: "This beta invitation was removed. Contact the MilestoneProof operator." }, { status: 403, headers: noStoreJsonHeaders() });
