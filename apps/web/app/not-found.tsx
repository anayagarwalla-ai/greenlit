  ...
  return (
    <main className="not-found-page">
      <section className="not-found-card">
        ...
        <p>The link may be incomplete or the page may have moved. Return to Greenlit, explore the public resources, or start the walkthrough.</p>
        <div className="not-found-actions">
          ...
          <Link href="/workspace?demo=guided">Start the walkthrough</Link>
        </div>
      </section>
    </main>
  );
