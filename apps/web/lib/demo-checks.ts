...
export function fixtureChecks(version: "rc1" | "rc2"): CheckSpec[] {
  ...
  return [
    ...
    { id: `${version}-02`, criterionId: "AC-02", type: "link_destination", path, sourceQuote: source["AC-02"]!, confirmedByHuman: true, elementRef: "link:Plan my trip", expectedPath: "/contact" },
