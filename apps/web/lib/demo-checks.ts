...
export function fixtureChecks(version: "rc1" | "rc2"): CheckSpec[] {
  ...
  return [
    ...
    { id: `${version}-02`, criterionId: "AC-02", type: "link_destination", path, sourceQuote: source["AC-02"]!, confirmedByHuman: true, elementRef: "link:Plan my trip", expectedPath: path },
    ...
    { id: `${version}-05`, criterionId: "AC-05", type: "axe_scan", path: `${path}#contact`, sourceQuote: source["AC-05"]!, confirmedByHuman: true, tags: ["wcag2a", "wcag2aa", "wcag22aa"], failImpacts: ["critical", "serious"] },
