...
export function FixtureSite({ version }: { version: "rc1" | "rc2" }) {
  ...
  return (
    <main className="fixture">
      ...
      <section className="fixture-hero"><div><span>Tailored journeys into the wild</span><h1>Adventure,<br />made simple.</h1><a href="#contact" role="button">Plan my trip</a></div><div className="fixture-sun" aria-hidden="true"><i /></div></section>
      <section id="trips" className="fixture-section" aria-labelledby="trips-title"><span>WAYS TO EXPLORE</span><h2 id="trips-title">Trip planning</h2><div className="fixture-cards"><article><b>01</b><h3>Weekend reset</h3><p>Two nights, one trail, zero logistics.</p></article><article><b>02</b><h3>Grand expedition</h3><p>A week shaped around your wild side.</p></article><article><b>03</b><h3>Family outside</h3><p>Small legs, big wonder, easier days.</p></article></div></section>
