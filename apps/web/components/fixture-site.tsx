...
export function FixtureSite({ version }: { version: "rc1" | "rc2" }) {
  ...
  return (
    <main className="fixture">
      ...
      <section id="about" className="fixture-hero"><div><span>Tailored journeys into the wild</span><h1>Adventure,{" "}<br />made simple.</h1><a href="#contact">Plan my trip</a></div><div className="fixture-sun" aria-hidden="true"><i /></div></section>
